...
export default function Home() {
  return (
    <>
      ...
      <div className="flex flex-col mx-auto mt-8 md:mt-16 p-4 md:max-w-2xl mb-12 text-neutral-100">
        <h1 className="text-5xl font-serif text-neutral-100">Aly Hassan Youssef</h1>
        <h2 className="text-2xl mt-8 font-semibold text-neutral-100">Some things about me:</h2>

        <ul className="list-disc mt-4 pl-5 space-y-2 text-neutral-300">
        ...
        <h2 className="text-2xl mt-8 font-semibold text-neutral-100">Some of the things I&apos;m interested in:</h2>
        <ul className="list-disc mt-4 pl-5 space-y-2 text-neutral-300">
        ...
        <p className='mt-8 font-semibold text-neutral-300'>Checkout my <Link className='underline text-blue-600' href={'/reading'}>reading</Link> and <Link className='underline text-blue-600' href={'/deep-dives'}>deep dives</Link></p>
      </div >
    </>
  );
}
